      ...
      <div class="auth-card">
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          <div class="form-group">
            ...
            />
            <span class="error" *ngIf="form.get('email')?.errors?.['required'] && form.get('email')?.touched">
              Email is required
            </span>
          </div>
...
export class LoginComponent {
  ...
  constructor(
    ...
    // Initialize bindings after DI so we don't reference `this.fb`/`this.store`
    // before Angular constructs the component.
